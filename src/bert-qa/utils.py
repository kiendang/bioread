...
# DATA_DIR = Path('/home/kien/bioread_lite/lite/')
...
# text = next(VALID.glob('xx*')).read_text()
# print(text)
...
# result = Example(token_ids, attention_mask, segment_ids,
#                  p_mask_flat, candidates, start_position_indicator)
